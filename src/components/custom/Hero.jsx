...
const Hero = () => {
  return (
    <div className="relative flex flex-col items-center justify-center text-center gap-8 md:gap-12 min-h-screen bg-cover bg-center" style={{ backgroundImage: 'url(./bg.jpg)' }}>
    {/* Overlay */}
    ...
    <div className="relative z-10">
      <h1 className="font-extrabold text-3xl lg:text-7xl md:text-7xl text-[#f56551]">
        TripBot: Test Your AI Travel Companion
      </h1>
      ...
      <p className="text-lg lg:text-2xl md:text-2xl mx-4 md:mx-16 lg:mx-16 text-white my-4" style={{lineHeight:"40px"}}>
